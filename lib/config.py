...
sentinel_cfg = AmeroConfig.tokenize(sentinel_config_file)
sentinel_version = "1.1.0"
min_amerod_proto_version_with_sentinel_ping = 70207


def get_amero_conf():
    home = os.environ.get('HOME')

    amero_conf = os.path.join(home, ".amerocore/amero.conf")
    if sys.platform == 'darwin':
        amero_conf = os.path.join(home, "Library/Application Support/AmeroCore/amero.conf")

    amero_conf = sentinel_cfg.get('amero_conf', amero_conf)
