...
class GovernanceClass(object):
    ...
    def list(self):
        ...
        # return a dict similar to amerod "gobject list" output
    ...
    def amerod_serialise(self):
        import amerolib
        return amerolib.SHIM_serialise_for_amerod(self.serialise())
